...
void DoFlyingControl(object *objp) {
  ...
  //log_input.open("./log_input_islide.txt"); // where to close the file ?
  // where am I? is this function called every frame or once and for all?

  // Read the controllers
  ReadPlayerControls(&controls); //, &log_input); //islide

  //log_input.close(); // islide : there's kind of no point in doing open/close every frame 
