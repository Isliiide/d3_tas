...
//islide -----------------------------
void demo_jump_to_frame(int val);

std::ofstream* get_ofstream_dump_newFrames();
bool get_demo_eof();
void set_demo_eof(bool b);
bool get_demo_parsed_first_pass();
void set_demo_parsed_first_pass(bool b);
