...
struct shrunk_gc {
  ...
  uint8_t ab = 0; // float to u8
  uint8_t atk = 0; //a1 a2 b1 b2
  uint8_t atk1f = 0;
  uint8_t atk2f = 0;
...
// islide ============================
// used to initialize a global vector of inputs to read from
void fill_vec_gc(std::vector<game_controls *> *vec_gc);

// used to free memory of the game_controls instances
void delete_vec_gc(std::vector<game_controls *> *vec_gc);

// used to initialize a global vector of inputs to read from (shrunk)
